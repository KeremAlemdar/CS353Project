...
$query2 = "DELETE FROM `reservation_hotel` WHERE `reservation_hotel`.`reservation_id` = $reservation_id";
$query3 = "DELETE FROM `reservation` WHERE `reservation`.`reservation_id` = $reservation_id";
