	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Manage <b>Tours Reservation Acceptance</b></h2>
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover">
				...
				<tbody>
                        ...
                        <?php 
						$sql = "SELECT * FROM `reservation_tour` NATURAL JOIN `tour` NATURAL JOIN `customer_reserve` NATURAL JOIN `customer`,`account` WHERE `account`.`user_id` = `customer`.`customer_id` AND `customer_reserve`.`acceptance_status` = 2  ORDER BY `tour`.`tour_id` ASC;";
