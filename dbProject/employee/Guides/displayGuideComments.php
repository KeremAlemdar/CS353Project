...
$query = "SELECT fname FROM guide , account where guide_id = $guide_id AND account.user_id = guide.guide_id";
$result = $mysqli->query($query);
$hotel = $result->fetch_array(MYSQLI_NUM);
$query = "select * from evaluate_guide where guide_id = $guide_id";
